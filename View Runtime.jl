...
# ╔═╡ a063e2a8-bc50-11ee-0ea6-e54962d89466
begin
	using Plots
	using PlutoUI
	using Dates
...
# ╔═╡ a6685115-8299-4d92-930e-4473ca655f42
html"""
...
# ╔═╡ 4bda6d19-30be-41b7-a258-767d9203123c
md"""
Find with command

	grep -a '🍏🥝' ~/Results/N-player\ CC/log.txt
"""

# ╔═╡ e6a72d6c-253d-4197-add2-b1887a9b2b71
@bind logs TextField((80, 10))

# ╔═╡ 519819cb-f080-4f65-a873-3f87199700d7
timestamp_matches = 
	eachmatch(r"(\d+)/(\d+) (\d+):(\d+).*🍉🍌 Running Fleet of (\d+) Cars", logs) |> collect

# ╔═╡ cbe103e5-c2d9-46e3-ae2a-d0363ce17629
timestamp_matches′ = [[parse(Int, i) for i in m] for m in timestamp_matches]

# ╔═╡ 09de3bee-3947-4a5b-9143-c63f6ec9c6c1
...
[canonicalize(t) for t in runtimes]

# ╔═╡ 461320d4-be02-4036-afee-46cfb0eaab87
bar(runtimes)

# ╔═╡ d961f457-30d7-44cb-baa1-c6cc400c69fe
...
manifest_format = "2.0"
project_hash = "c852e4c647b0274491cb0b86a880848a250b296a"
