...
Since the shield affects both cars at once, the cars are also trained using a centralized controller, since who knows what other policy we might get.

I want to compare this with a centralized controller training on two normal shields on maximum distance 50m.
...
## Files
 ...
 - *3-Car.xml* is the same but with one single-car shield for each of the two controlled cars. 
