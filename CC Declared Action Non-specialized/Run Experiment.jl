...
begin
	...
	@add_arg_table s begin
        ...
        "--declared-action-shield-path"  
            default=pwd() ⨝ "../CC Shield/libdecalredactionshield.so"
        "--skip-training"
            action=:store_true
...
declared_action_shield_path′ = results_dir ⨝ basename(declared_action_shield_path)
cp(declared_action_shield_path, declared_action_shield_path′, force=true)
declared_action_shield_path = declared_action_shield_path′
