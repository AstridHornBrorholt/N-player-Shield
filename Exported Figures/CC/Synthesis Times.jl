...
Constants have been read from the notebook cell runtimes.
"""

# ╔═╡ ee2b4f86-43da-49ad-be64-4c7595bc73b6
begin
	# Synthesis times.

	# 2-car shield with 200m max distance
	decentralized_200 = 0.44 + 4.7 + 1.6
	
	# 2-car shield with 50m max distance
	decentralized_50 = 0.1 + 1.3 + 0.28

	# 2-car shield that allows co-ordinating actions with 200m max distance
	coop_200 = 0.8 + 16.9 + 14.2
	
	# 2-car shield that allows co-ordinating actions with 50m max distance
	coop_50 = 0.2 + 3.9 + 2.2

	# 3-car shield with 50m max distance
	centralized_50 = 30 + 3566 + 1097
end;

# ╔═╡ 730a7d04-e970-44fb-a860-f97e3f974575
#=╠═╡
@bind max_cars NumberField(2:10, default=4)
  ╠═╡ =#

# ╔═╡ c3574c0d-fb9c-4a1b-9bfc-4bd4f3e34226
#=╠═╡
decentralized_times = [decentralized_50 for _ in 1:max_cars]
  ╠═╡ =#

# ╔═╡ 16daa635-6538-4cf8-8e02-e6ea9c8213bb
#=╠═╡
coop_times = [coop_50 for _ in 1:max_cars]
  ╠═╡ =#

# ╔═╡ 9a0714a8-1a0c-4daa-8d21-955990029509
centralized_times = [decentralized_50, centralized_50]

# ╔═╡ 960a5dcb-e043-431d-9d09-6c504ce70804
#=╠═╡
begin
	...
	plot(
		...
		ylabel="Shield Synthesis (seconds)",)
	
	plot!(decentralized_times,
		color=colors.PETER_RIVER,
		linewidth=2,
		marker=:pentagon,
		markerstrokewidth=0,
		label="Distributed shields")
	...
	plot!(coop_times,
		...
		markerstrokewidth=0,
		color=colors.ORANGE,
		label="Co-operative, distributed shields")

	
	plot!(centralized_times,
		linewidth=2,
		marker=:rtriangle,
		markersize=8,
		markerstrokewidth=0,
