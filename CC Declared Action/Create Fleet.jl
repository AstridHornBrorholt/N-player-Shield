...
#=╠═╡
@bind(shield_path,
	TextField(80, default=realpath(pwd() ⨝ "../CC Shield/libshield.so")))
  ╠═╡ =#

# ╔═╡ ccad33cc-4b17-4644-8298-baa978c4766d
#=╠═╡
@bind(declared_action_shield_path, 
	TextField(80, default=realpath(pwd() ⨝ 
		"../CC Shield/libdecalredactionshield.so")))
  ╠═╡ =#
...
# ╔═╡ bc05e33f-d9f5-43dc-bfd9-60232c1794b6
queries(4, "/some/path", observe_front_action=true) |> multiline
...
#=╠═╡
@bind blueprint_path TextField(95, default=pwd() ⨝ "Declared Action Fleet_blueprint.xml")
  ╠═╡ =#
...
#=╠═╡
md"""
$(@bind open_destination_button CounterButton("Open Destination"))
(Ubuntu only)
"""
  ╠═╡ =#
...
#=╠═╡
if open_destination_button > 0
	run(`nautilus $destination`, wait=false)
end
  ╠═╡ =#
...
- `declared_action_shield_path`: Path to the compiled safety strategy, `libdeclaredactionshield.so`.
...
#=╠═╡
create_fleet(blueprint_path, strategy_paths, 
	shield_path, declared_action_shield_path, destination)
  ╠═╡ =#
