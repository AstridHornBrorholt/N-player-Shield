...
export log_output="$HOME/Results/N-player CC Declared Action Non-specialized/log.txt"

date >> "$log_output"

#sinfo -h -o %N >> dhabi[01-09],naples[01-09],rome[01-07],turing[01-02],vmware[01-04]
ARGS="--out=/dev/null --partition=rome -n1 --mem=16G --job-name CCDeclaredActionNonSpecialized"
